  ...
  getData() {
    getScore((scoreArray)=>{
      let data = {
        success: true,
        leaders: [
          { id: 1, name: scoreArray[0].name, score: scoreArray[0].score },
          { id: 3, name: scoreArray[1].name, score: scoreArray[1].score },
          { id: 2, name: scoreArray[2].name, score: scoreArray[2].score },
          { id: 4, name: scoreArray[3].name, score: scoreArray[3].score },
          { id: 5, name: scoreArray[4].name, score: scoreArray[4].score }],
  
        maxScore: scoreArray[0].score
      };
  ...
  render() {
    return (
      React.createElement("div", { className: "Leaderboard" },
        React.createElement("h1", null, "MCSLab Leaderboard"),
